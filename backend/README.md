...
## Project Structure
    ...
    ├── testprdcatalog_dev_57219  # Django project configurations
...
1. Clone this repo and `cd testprdcatalog_dev_57219`
...
2. Clone this repo and `cd testprdcatalog_dev_57219`
