"""
Django settings for testprdcatalog_dev_57219 project.
...
ROOT_URLCONF = 'testprdcatalog_dev_57219.urls'
...
WSGI_APPLICATION = 'testprdcatalog_dev_57219.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testprdcatalog_dev_57219 API",
    "DESCRIPTION": "API documentation for testprdcatalog_dev_57219 App",
    "VERSION": "v1",
}
